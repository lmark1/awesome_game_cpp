...
// configuration step. It creates a namespace called `awesome_game_cpp`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        awesome_game_cpp::cmake::project_name,
        awesome_game_cpp::cmake::project_version));// version string, acquired
